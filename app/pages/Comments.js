...
const star1 = require('../images/star.png')
const star2 = require('../images/star-1.png')
...
export default class Comments extends Component {
  ...
  renderComments(){
    let scale = 1/5*55
    return [
      {avatar: avatar, name: "_平***空", scores: 1, time: "2017-01-01", content: "味道跟屎一样！！熏死我了。。", tag: "分量一般 味道不好"},
      {avatar: avatar, name: "_平***空", scores: 2, time: "2017-01-01", content: "味道还可以，尤其是那个大便。。", tag: "味道还可以"}]
    .map((item, i) => {
            ...
            <View style={styles.uinfo}>
              ...
              <View style={{marginLeft: 5}}>
                ...
                <View style={{height: 10}}>
                  <Image source={star2} style={{height: 10, width: 55}}/>
                  <View style={{height: 10, position:"absolute", left:0, top:0, width: scale, overflow:"hidden"}}>
                    <Image source={star1} style={{height: 10, width: 55}}/>
                  </View>
                </View>
              </View>
            </View>
